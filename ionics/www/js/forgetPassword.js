angular.module('conFusion.controllers').controller('forgetPasswordCtrl', function ($scope, $ionicModal, $timeout, $localStorage, $ionicPopup, $ionicLoading) {


    console.log("forgetPasswordCtrl is working..");
